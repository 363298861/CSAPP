...
int isAsciiDigit(int x) {
  return (!(((~x + 1) + 0x39) >> 31)) & (((~x + 1) + 0x2f) >> 31);
}
/* 
...
int isLessOrEqual(int x, int y) {
  ...
  int xSign = x >> 31;
  int ySign = y >> 31;
  int c1 = !less & !(xSign ^ ySign);
  int c2 = (xSign ^ ySign) & xSign;
    return c1 | c2;
}
//4
/* 
...
unsigned floatScale2(unsigned uf) {
    ...
    int significand = (uf & 0x7f800000) >> 23;
    int sign = uf & (1 << 31);
    if(significand == 0 || significand == 255){
      return uf;
    }
    significand++;
    if(significand == 255) return 0x7f800000 | sign;
    return (significand<<23)|(uf&0x807fffff);
}
/* 
 ...
 *Score	Rating	Errors	Function
 ...
 1	1	0	tmin
 1	1	0	isTmax
ERROR: Test allOddBits(-4[0xfffffffc]) failed...
...
ERROR: Test floatScale2(-2147483648[0x80000000]) failed...
...Gives -2139095040[0x80800000]. Should be -2147483648[0x80000000]
